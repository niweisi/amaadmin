...
$adsubstr=utf8substr($_M['user']['admin_name'], 0, 3);
...
-->		
					...
					<li class="list lang">
						<a href="index.php?lang={$lang}" class="lang_name">{$adsubstr}<i class=" fa fa-caret-down"></i></a>
						<dl>
