					...
					$.ajax({
						...
						success: function(data) {
							if (data.error) {
								...
								$('.appdetail').show();
								$('.downloaddiv').show();
								$('.download').html("<a>"+langtxt.downloads+"...</a>");
								$('.buybuttondiv').hide();
								$('.download').click();
							}
					...
					if(data.products.a == 'cmsupdate'){
						...
						if(datadownload == 1){
							if(data.products.a == 'update'){
								$('.downloaddiv').show();
								$('.download').html("<a>"+langtxt.appupgrade+"</a>");
							}else{
								$('.completediv').show();
							}
						}else{
							if(data.products.a == 'buy'){
								...
								if(data.products.price==0){
									$('.download').html("<a href='#'>"+langtxt.appinstall+"</a>");
								}else{
									$('.download').html("<a href='#'>"+langtxt.appinstall+"</a>"+langtxt.have_bought);
								}
								$('.downloaddiv').show();
							}
						}
